...
def res2net50_v1b(pretrained=True, **kwargs):
    ...
    if pretrained:
        model.load_state_dict(torch.load('D:/Lable/My-Lable1/save_weights/res2net50_v1b_26w_4s-3cf99910.pth'))
    return model
...
def res2net50_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    model = Res2Net(Bottle2neck, [3, 4, 6, 3], baseWidth=26, scale=4, **kwargs)
    # if pretrained:
    #     model_state = torch.load('D:/Lable/LDNet-main/save_weights/res2net50_26w_4s-06e79181.pth')
